...
namespace hotel_v2
{
    public partial class Staff : Form
    {
        ...
        {
            if (tbId.Text == "" || tbNama.Text == "" || tbNo.Text == "" || cbGender.Text == null || tbUsername.Text == "" || tbPassword.Text == "")
            {
            ...
            cmd = new SqlCommand("SELECT COUNT(*) FROM tbl_Staff WHERE StaffId = @StaffId", conn);
            ...
            cmd = new SqlCommand("INSERT INTO tbl_Staff VALUES (@StaffId, @StaffName, @StaffPhone, @gender, @StaffUsername, @StaffPassword)", conn);
            cmd.Parameters.AddWithValue("@StaffId", tbId.Text);
